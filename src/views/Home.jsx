  ...
  return (
    <div className="container-fluid px-4">
      <nav className="brand-bar row justify-content-center">
        <div className="imageContainer col-12 col-sm-10 col-md-9 col-lg-11 text-left">
      ...
      <header className="hero-section">
        <div className="row justify-content-center justify-content-lg-center gx-5">
          <div className="imageContainer col-12 col-sm-10 col-md-9 col-lg-6">
            <img className="image img-fluid" src={ Mockup } alt="" />
          </div>
          <div className="copyContainer col-12 col-sm-10 col-lg-5 text-lg-start">
